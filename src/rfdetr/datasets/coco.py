...
class CocoDetection(torchvision.datasets.CocoDetection):
    def __init__(self, img_folder: Union[str, Path], ann_file: Union[str, Path], transforms: Optional[Any], include_masks: bool = False, include_keypoints: bool = False, num_keypoints: bool = 17) -> None:
...
class ConvertCoco(object):
    ...
    def __init__(self, include_masks: bool = False, include_keypoints: bool = False, num_keypoints: int = 17, cat_id_to_continuous: Optional[Dict[Any, Any]] = None) -> None:
        self.include_masks = include_masks
        self.include_keypoints = include_keypoints
